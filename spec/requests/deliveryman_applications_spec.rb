...
RSpec.describe "Deliveryman Applications", type: :request do
  describe "POST /applications" do
    it "should fail if current user is not a deliveryman" do
      ...
      post '/applications', params: { deliveryman_application: attributes_for(:deliveryman_application) }, headers: { "Auth-Token": token }
    ...
    it "should fail if attributes are not given" do
      ...
      post '/applications', params: { deliveryman_application: attributes_for(:deliveryman_application, cnh: nil, vehicle_type: nil) }, headers: { "Auth-Token": token }
